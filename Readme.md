...
- **Enhanced Navigation:** Smart file tree (`nvim-tree.lua`), project management (`project.nvim`), and quick navigation.
...
2.  **Clone the Repository:** Clone this repository into your Neovim configuration directory:
    ...
    ```bash
    git clone [https://github.com/yourusername/steix.nvim.git](https://github.com/yourusername/steix.nvim.git) ~/.config/nvim
    ```

    _(Replace `yourusername/steix.nvim` with your actual repository path)_
...
| :------------------- | :------------------------------------------------- |
| `<leader>pv`         | Open the `nvim-tree.lua` file explorer.            |
...
| `snacks.nvim`                                       | Enhanced diagnostics display and features.       |
